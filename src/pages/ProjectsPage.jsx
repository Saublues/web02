...
const allProjects = [
  ...
  },
  {
    ...
    category: "Frontend",
    description:
      "Serverless Laundry Booking UI — A lightweight, interactive frontend application that leverages Google Apps Script to seamlessly sync scheduling and order data directly into a spreadsheet.",
    image: resiklaundry,
    span: "",
  ...
  },
  {
    ...
    category: "Frontend",
    description:
      "Suryakshana: CLI Railway Management — A Python terminal appslication featuring role-based access for efficient train schedule tracking, route monitoring, and administrative data entry.",
    image: suryakshana,
    span: "md:col-span-2",
        ...
        <div className="relative pt-32 lg:pt-40 pb-16 lg:pb-20 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div style={{ y: headerY, opacity: headerOpacity }}>
              ...
              >
                A complete showcase of projects across the full
                stack&nbsp;&mdash; from system architecture to pixel-perfect
                interfaces.
              </motion.p>
            </motion.div>
          </div>
                      ...
                      <div className="relative overflow-hidden">
                        <motion.img
                          ...
                          className={`w-full object-cover transition-transform duration-700 ease-out ${
                            project.span ? "h-60 md:h-80" : "h-56 md:h-64"
                          }`}
                          style={{
                            transform:
